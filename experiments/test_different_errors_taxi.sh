...
mkdir -p experiments/taxi/different_errors

# Define the error bounds
error_bounds=(0.05 0.02 0.01 0)
...
do
    ...
    do
        ...
        -rect -73.99831454:-73.97500902,40.7151612032:40.73263959 -xCol 5 -yCol 6 -measureCol 16 \
        -initMode valinor \
        -objCount 165000000 -seqCount 100 -minShift 10 \
        -maxShift 20 -out experiments/taxi/different_errors/results_${error_bound}_run${run}.csv \
