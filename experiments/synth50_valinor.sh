...
mkdir -p experiments/results/synth50/pan_zoom_scenario/
...
do
    ...
    do
        ...
        do
            ...
            timeApproximateQueries -csv /data-nonraid/maroulis/data/data_50_cols.csv -bounds 0:1000,0:1000 \
            -rect 544:574,323:353 -xCol 0 -yCol 1 -measureCols $measure_cols \
            -initMode valinor \
            -objCount 100000000 -seqCount 100 -minShift 10 \
            -maxShift 20 -zoomFactor 1.5 -out experiments/results/synth50/pan_zoom_scenario/results_mcols${num_cols}_error${error_bound}_run${run}.csv \
