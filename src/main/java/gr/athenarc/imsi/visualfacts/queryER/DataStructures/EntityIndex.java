...
public class EntityIndex implements Serializable {
    ...
    private long validEntities1;
    private long validEntities2;
    ...
    public long[] getEntityBlocks(int entityId, int useDLimit) {
    ...
    public long getValidEntities1() {
        return validEntities1;
    }

    public long getValidEntities2() {
